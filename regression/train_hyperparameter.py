...
def main():
    ...
    parser.add_argument('--prot_layers', type=int, default=6, help='Number of GAT layers for protein')
    parser.add_argument('--prot_gvp_layer', type=int, default=6, help='Number of GVP layers for protein')
    parser.add_argument('--drug_layers', type=int, default=3, help='Number of GAT layers for drug')
